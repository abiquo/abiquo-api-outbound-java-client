...
/**
 * Class for representing backup events received from the M server. No extra processing is required
 * compared to a standard VirtualMachineEvent event. This class is simply required so that plugins
 * can define a method to receive just backup events.
 */
public class BackupVMEvent extends VirtualMachineEvent
{
    ...
    public BackupVMEvent(final EventDto event, final Optional<MetadataDto> optMetaData)
    {
